    ...
    <>
      ...
      <aside className={`principal ${isOpen ? "open" : "closed"}`}>
          ...
          <ul>
            {!isAuthenticated && (
              <>
                <li>
                  <Link
                    className="hover-scale2 w-full py-2 px-4 flex justify-between items-center hover:bg-slate-300 hover:rounded-2xl"
                    to="/login"
                  >
            ...
            {isAuthenticated && (
              <li>
                <Link
                  ...
                  to="/profile"
                >
                  <span>Profile</span> <button className="btnGo">Go</button>
                </Link>
              </li>
            )}
          </ul>
        ...
        <div>
          <ul className="links">
            <li>
              <Link className="hover-scale2 w-full flex items-center gap-2">
